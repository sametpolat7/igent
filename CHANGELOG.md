...
- Updated documentation with placeholder values for server configurations
- Replaced example server names and directories with generic placeholders

## [1.0.3] - 2026-02-06

### Changed

- Removed all references to "iwallet" and "iWallet" from codebase and documentation
- Updated server configuration directory naming for consistency
- Updated SSH configuration examples with generic placeholders
